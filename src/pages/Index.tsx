    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F2F4F6' }}>
      ...
      <main className="max-w-[1286px] mx-auto px-4 md:px-6 py-6">
        ...
        <div className="lg:hidden">
          <h2 className="text-[17px] font-bold mb-4" style={{ color: '#1A2B3D' }}>{cv('company_name', 'Agro Brasil')} é confiável?</h2>
          ...
          <ComplaintsSection companyName={cv('company_name', 'Agro Brasil')} />
          <FAQSection />
          ...
          <div className="mt-8">
            <div className="bg-background rounded-xl p-6 text-center" style={{ border: '1px solid #E8ECF0' }}>
              ...
              <h3 className="text-lg font-bold mb-2" style={{ color: '#1A2B3D' }}>Descontos de {cv('company_name', 'Agro Brasil')}</h3>
        ...
        <div className="hidden lg:grid grid-cols-[280px_1fr_280px] gap-6">
          <div>
            <h2 className="text-xl font-bold mb-4" style={{ color: '#1A2B3D' }}>{cv('company_name', 'Agro Brasil')} é confiável?</h2>
